...
const ToldmaessigAendringTilbagebetaling = React.memo(({ value, setState, handleEnterKey }) => {
    return (
      <HelperText title='Toldmæssig beløb der er tilbagebetalt. Fx. 1150,50'>
        <TextField
...
export default withEnterKeyPressed(ToldmaessigAendringTilbagebetaling)
